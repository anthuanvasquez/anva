	...
	$styles = array(
		...
		'header' => array(
			...
			'breaking_display' => array(
				'name' => NULL,
				'desc' => sprintf( '<strong>%s:</strong> %s', __( 'Breaking News', 'anva' ), __( 'Display breaking news above header.', 'anva' ) ),
				'id' => 'breaking_display',
				'std' => '0',
				'type' => 'checkbox',
				'trigger' => '1',
			...
			'breaking_items' => array(
				'name' => __( 'Breaking News Items', 'anva' ),
				'desc' => __( 'Choose the default items to show on breaking news.', 'anva' ),
				'id'   => 'breaking_items',
				'std'  => 5,
				'type' => 'number',
			),
			'breaking_categories' => array(
				'name' => __( 'Breaking News Categories', 'anva' ),
				'desc' => __( 'Select the categories from blog you want to show on breaking news.', 'anva' ),
