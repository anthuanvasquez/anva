	...
	public function scripts() {
		...
		foreach ( $this->args['page'] as $page ) {
			...
			if ( $typenow == $page ) {
				...
				wp_enqueue_script( 'anva-media-gallery',ANVA_FRAMEWORK_ADMIN_JS . 'page-gallery.js', array(), ANVA_FRAMEWORK_VERSION, true );
				wp_localize_script( 'anva-media-gallery', 'anvaGalleryVar', anva_get_admin_locals( 'metabox_js' ) );
				wp_enqueue_style( 'anva-gallery', ANVA_FRAMEWORK_ADMIN_CSS . 'page-gallery.css', array(), ANVA_FRAMEWORK_VERSION, 'all' );
