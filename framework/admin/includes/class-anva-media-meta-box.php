...
class Anva_Media_Meta_Box {
	...
	public function media() {
		...
		printf( '<p class="tzp-intro">%1$s</p>', __( 'Set up your audio media for display in your portfolio. Only 1 file type is required for audio to work in all browsers, but the providing additional file types will ensure that users view an HTML5 audio element if available.', 'anva' ) );
...
function tzp_render_portfolio_settings_fields( $post_id ) {
	?>
	<div class="tzp-field">
		<h4><?php _e('Project Media', 'anva'); ?></h4>
		<div class="tzp-left">
			...
			<ul class="tzp-inline-checkboxes">
				<li>
					...
					<label for="_tzp_display_gallery"><?php _e('Display Gallery', 'anva'); ?></label>					
				</li>
				<li>
					...
					<label for="_tzp_display_audio"><?php _e('Display Audio', 'anva'); ?></label>					
				</li>
				<li>
					...
					<label for="_tzp_display_video"><?php _e('Display Video', 'anva'); ?></label>					
				</li>
			</ul>
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Select the media formats that should be displayed.', 'anva'); ?></p>
		</div>
	</div>
	<?php
}
...
?>
	...
	<div class="tzp-field">
		<h4><?php _e('Poster Image:', 'anva'); ?></h4>	
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_audio_poster_url_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_audio_poster_url_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Add a poster image to your audio player (optional).', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('.mp3 File:', 'anva'); ?></h4>
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_audio_file_mp3_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_audio_file_mp3_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Insert an .mp3 file, if desired.', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('.ogg File:', 'anva'); ?></h4>
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_audio_file_ogg_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_audio_file_ogg_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Insert an .ogg file, if desired.', 'anva'); ?></p>
		</div>
	</div>
<?php
}
...
?>
	<div class="tzp-field">
		...
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_video_poster_url_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_video_poster_url_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Add a poster image for your video player (optional).', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('.m4v File:', 'anva'); ?></h4>	
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_video_file_m4v_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_video_file_m4v_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Insert an .m4v file, if desired.', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('.ogv File:', 'anva'); ?></h4>
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_video_file_ogv_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_video_file_ogv_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Insert an .ogv file, if desired.', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('.mp4 File:', 'anva'); ?></h4>
		<div class="tzp-left">
			...
			<input type="button" class="tzp-upload-file-button button" name="_tzp_video_file_mp4_button" data-post-id="<?php echo $post_id; ?>" id="_tzp_video_file_mp4_button" value="<?php esc_attr_e( 'Browse', 'anva' ); ?>" />
		</div>
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php _e('Insert an .mp4 file, if desired.', 'anva'); ?></p>
		</div>
	</div>

	<div class="tzp-field">
		<h4><?php _e('Video Embed:', 'anva'); ?></h4>
		<div class="tzp-left">
		...
		<div class="tzp-right">
			<p class='tzp-desc howto'><?php printf( '%1$s <br /><br /><strong>%2$s</strong>.', __('Embed iframe code from YouTube, Vimeo or other trusted source. HTML tags are limited to iframe, div, img, a, em, strong and br.', 'anva'), __('Note: This field overrides the previous fields.', 'anva') ); ?></p>
		</div>
	</div>
<?php
}