...
jQuery( document ).ready( function( $ ) {
    ...
    var AnvaPageBuilderManager = {
        ...
        init: function() {
            ...
            AnvaPageBuilderManager.active();
            // AnvaPageBuilderManager.dragItems();
            AnvaPageBuilderManager.sortItems();
            AnvaPageBuilderManager.addRow();
            AnvaPageBuilderManager.addItem();
            AnvaPageBuilderManager.editItem();
            AnvaPageBuilderManager.moveItem();
            AnvaPageBuilderManager.addColumns();
            AnvaPageBuilderManager.removeItem();
            AnvaPageBuilderManager.removeAllItems();
            AnvaPageBuilderManager.itemData();
            AnvaPageBuilderManager.publish();
            AnvaPageBuilderManager.tooltip();
            AnvaPageBuilderManager.importExport();
            AnvaPageBuilderManager.extras();
        ...
        dragItems: function() {
            s.element.draggable({
                ...
                zIndex: 199,
                helper: function(e) {
                    var item = AnvaPageBuilderManager.buildItem();
