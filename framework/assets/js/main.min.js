		...
		blogFilter: function(){
			$('.category-filter li a').on( 'click', function(e) {
				...
				$.ajax({
					...
					type: 'POST',
					data: 'action=anva_blog_posts_filter&cat=' + filterCat + '&items=' + filterItems,
					success: function( results ) {
						ANVA.portfolio.gridInit();
						$(filterContainer).removeClass('filter-loading').html( results ).show();
						$(filterContainer).find('.entry').each( function() {
