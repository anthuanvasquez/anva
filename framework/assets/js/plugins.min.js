!function(){for(var i,e=function(){},a=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],t=a.length,n=window.console=window.console||{};t--;)i=a[t],n[i]||(n[i]=e)}();
/*!
