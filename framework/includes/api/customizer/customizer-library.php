...
if ( ! class_exists( 'Customizer_Library' ) ) :
	...
	require 'extensions/interface.php';

	// Helper functions for customizer sanitization.
	require 'extensions/sanitization.php';

	// Helper functions to build the inline CSS.
	require 'extensions/style-builder.php';

	// Helper functions for fonts.
	require 'extensions/fonts.php';

	// Utility functions for the customizer.
	require 'extensions/utilities.php';

	// Customizer preview functions.
	require 'extensions/preview.php';

	// Textarea control
	if ( version_compare( $GLOBALS['wp_version'], '4.0', '<' ) ) {
		require 'custom-controls/textarea.php';
	}

	// Arbitrary content controls
	require 'custom-controls/content.php';
