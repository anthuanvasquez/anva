...
class Custom_Services extends WP_Widget {
	...
	function Custom_Services() {
		...
		$widget_ops = array(
			...
			'description' => __('Muestra servicios personalizados con una imagen y una descripción.', TM_THEME_DOMAIN)
		);
	...
	function form( $instance ) {
		...
		<!-- Image -->
		<p>
			<label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('URL de Imagen:', TM_THEME_DOMAIN); ?></label>
		...
		<!-- Link -->
		<p>
			<label for="<?php echo $this->get_field_id('link'); ?>"><?php _e('URL de Enlace:', TM_THEME_DOMAIN); ?></label>
