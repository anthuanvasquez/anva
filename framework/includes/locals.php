...
function tm_get_text_locals() {
	...
	$localize = array(
		'menu_nav_off'						=> __( 'Por favor configura el menu en Administracion _> Apariencia _> Menus', $domain ),
		'404_title'								=> __( 'Whoops! pagina no encontrada', $domain ),
		'404_description'					=> __( 'Disculpa, pero la pagina solicitada no se pudo encontrar. Prueba haciendo una busqueda en el sitio o regresa a la pagina principal.', $domain ),
		'not_found'								=> __( 'No hay publicaciones', $domain ),
		'not_found_content'				=> __( 'No se encontraron publicaciones.', $domain ),
		'read_more'								=> __( 'Leer M&acute;s', $domain ),
		...
		'email_required'					=> __( 'Porfavor entre un correo electronico valido.', $domain),
		'email_error'							=> __( 'El correo electronico debe tener un formato valido ej. nombre@email.com.', $domain ),
		...
		'message_min'							=> __( 'Debe introducir un minimo de 10 caracteres.', $domain ),
		...
		'submit_message'					=> __( 'Gracias, su email fue enviado con exito.', $domain ),
