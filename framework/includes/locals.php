...
function anva_get_text_locals() {
	...
	$localize = array(
		'menu'										=> __( 'Menú', anva_textdomain() ),
		'menu_primary' 						=> __( 'Menú Primario', anva_textdomain() ),
		'menu_secondary' 					=> __( 'Menú Secundario', anva_textdomain() ),
		'menu_message'						=> __( 'Por favor configura el menú en Administración _> Apariencia _> Menús', anva_textdomain() ),
		'404_title'								=> __( 'Whoops! página no encontrada', anva_textdomain() ),
		...
		'search'		 							=> __( 'Buscar', anva_textdomain() ),
		'video'										=> __( 'Video', anva_textdomain()),
		'page'										=> __( 'Página', anva_textdomain() ),
		'page_options'						=> __( 'Opciones de Pagina', anva_textdomain()),
		...
		'sidebar_double'					=> __( 'Doble Sidebar', anva_textdomain() ),
		'sidebar_double_left'			=> __( 'Doble Sidebar Left', anva_textdomain() ),
		'sidebar_double_right'		=> __( 'Doble Sidebar Right', anva_textdomain() ),
		'post_grid'								=> __( 'Post Grid:' ),
		'grid_2_columns'					=> __( '2 Columnas', anva_textdomain() ),
		'grid_3_columns'					=> __( '3 Columnas', anva_textdomain() ),
		'grid_4_columns'					=> __( '4 Columnas', anva_textdomain() ),
		'posted_on'								=> __( 'Publicado en', anva_textdomain() ),
		'by'											=> __( 'por', anva_textdomain() ),
		'day' 										=> __( 'Día:', anva_textdomain() ),
		'month' 									=> __( 'Mes:', anva_textdomain() ),
		'year' 										=> __( 'Año:', anva_textdomain() ),
		'author' 									=> __( 'Autor:', anva_textdomain() ),
		'asides' 									=> __( 'Asides', anva_textdomain() ),
		'galleries' 							=> __( 'Galerías', anva_textdomain()),
		'images' 									=> __( 'Imágenes', anva_textdomain()),
		'videos' 									=> __( 'Vídeos', anva_textdomain() ),
