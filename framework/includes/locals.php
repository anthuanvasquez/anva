...
function anva_get_text_locals() {
	...
	$localize = array(
		...
		'menu_message'						=> __( 'Please set the menu in Administration / Appearance / Menus', anva_textdomain() ),
		'404_title'								=> __( 'Whoops! page not found', anva_textdomain() ),
		'404_description'					=> __( 'Sorry, but the page you requested could not be found. Try doing a search on the site or return to the home page.', anva_textdomain() ),
		'not_found'								=> __( 'No posts found', anva_textdomain() ),
		'not_found_content'				=> __( 'No posts found.', anva_textdomain() ),
		'read_more'								=> __( 'Read More', anva_textdomain() ),
		...
		'search_for' 							=> __( 'Search for:', anva_textdomain() ),
		'search_result'						=> __( 'Search Results for:', anva_textdomain() ),
		...
		'galleries' 							=> __( 'Galleries', anva_textdomain()),
		'images' 									=> __( 'Images', anva_textdomain()),
		'videos' 									=> __( 'Videos', anva_textdomain() ),
		'quotes' 									=> __( 'Quotes', anva_textdomain() ),
		'links'										=> __( 'Links', anva_textdomain() ),
		'status'									=> __( 'Estatus', anva_textdomain() ),
		'audios'									=> __( 'Audios', anva_textdomain() ),
		'chats'										=> __( 'Chats', anva_textdomain() ),
		'archives'								=> __( 'Archivos', anva_textdomain() ),
		'name' 										=> __( 'Name', anva_textdomain() ),
		'name_place' 							=> __( 'Complete Name', anva_textdomain() ),
