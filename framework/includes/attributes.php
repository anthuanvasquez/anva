...
/**
 * [anva_add_attributes description]
...
function anva_add_attributes() {
	...
	add_filter( 'anva_attr_entry', 'anva_attr_post', 5 );
	...
	add_filter( 'anva_attr_entry-summary', 'anva_attr_entry_summary', 5 );
	...
	add_filter( 'anva_attr_comment-content', 'anva_attr_comment_content', 5 );
}
...
function anva_attr_header( $attr ) {
	...
	$attr['id']        = 'header';
	$attr['class']     = anva_get_header_class( 'site-header' );
	$attr['role']      = 'banner';
	$attr['itemscope'] = 'itemscope';
...
function anva_attr_sidebar( $attr, $context ) {
	...
	if ( $context ) {
		...
		$sidebar_name = anva_get_sidebar_name( $context );
...
function anva_attr_entry_title( $attr ) {
	...
	$attr['id']       = 'entry-title-' . get_the_ID();
 ...
 * @return array
 */
function anva_attr_entry_summary( $attr ) {
 ...
 * @return array
 */
function anva_attr_comment_content( $attr ) {
